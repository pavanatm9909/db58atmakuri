...
router.get('/', function(req, res) {
  res.render('index', { title: 'Canteen App' ,user : req.user });
});

router.get('/register', function(req, res) { 
  res.render('register', { title: 'Canteen App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Canteen App Login', user : req.user }); 
}); 
